...
from .views import NewWorldCreateView, SelectGameView, InGameView, DeleteGameDeleteView, update_game_day, unlock_technology, update_technology_time
urlpatterns = [
    ...
    path('update_technology_time/<int:pk>/', update_technology_time, name='update_technology_time'),
