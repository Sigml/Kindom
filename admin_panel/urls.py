...
urlpatterns = [
    ...
    path('treade_agreement_create/', TradeAgreementCreateView.as_view(), name='treade_agreement_create'),
    path('treade_agreement_list/', TradeAgreementListView.as_view(), name='treade_agreement_list'),
    path('treade_agreement_update/<pk>/', TradeAgreementUpdateView.as_view(), name='treade_agreement_update'),
    path('treade_agreement_delete/<pk>/', TradeAgreementDeleteView.as_view(), name='treade_agreement_delete'),
    path('peace_teatry_create/', PeaceTreatyCreateView.as_view(), name='peace_teatry_create'),
    path('peace_teatry_list/', PeaceTreatyListView.as_view(), name='peace_teatry_list'),
    path('peace_teatry_update/<pk>/', PeaceTreatyUpdateView.as_view(), name='peace_teatry_update'),
    path('peace_teatry_delete/<pk>/', PeaceTreatyDeleteView.as_view(), name='peace_teatry_delete'),
